...
pub fn a64clz32(solver: &mut SolverCtx, x: SExpr, id: u32) -> SExpr {
    ...
    solver.assume(solver.smt.eq(y16, solver.smt.bvlshr(a64x, solver.smt.atom("#x00000010"))));
    solver.assume(solver.smt.list(vec![solver.smt.atom("ite"), solver.smt.list(vec![solver.smt.atom("not"), solver.smt.eq(y16, solver.smt.list(vec![solver.smt.atoms().und, solver.smt.atom("bv0"), solver.smt.numeral(32)]))]), solver.smt.eq(ret2, ret0), solver.smt.eq(ret2, solver.smt.list(vec![solver.smt.atom("bvadd"), ret0, solver.smt.list(vec![solver.smt.atoms().und, solver.smt.atom("bv16"), solver.smt.numeral(64)])]))]));
    solver.assume(solver.smt.list(vec![solver.smt.atom("ite"), solver.smt.list(vec![solver.smt.atom("not"), solver.smt.eq(y16, solver.smt.list(vec![solver.smt.atoms().und, solver.smt.atom("bv0"), solver.smt.numeral(32)]))]), solver.smt.eq(x16, y16), solver.smt.eq(x16, a64x)]));
    // round 2
    ...
    // last round
    let ret7 = solver.declare(format!("ret7_{id}", id = id), solver.smt.list(vec![solver.smt.atoms().und, solver.smt.atom("BitVec"), solver.smt.numeral(64)]));
    solver.assume(solver.smt.list(vec![solver.smt.atom("ite"), solver.smt.list(vec![solver.smt.atom("not"), solver.smt.eq(x1, solver.smt.list(vec![solver.smt.atoms().und, solver.smt.atom("bv0"), solver.smt.numeral(32)]))]), solver.smt.eq(ret7, ret6), solver.smt.eq(ret7, solver.smt.list(vec![solver.smt.atom("bvadd"), ret6, solver.smt.list(vec![solver.smt.atoms().und, solver.smt.atom("bv1"), solver.smt.numeral(64)])]))]));
    let clret = solver.declare(format!("clret_{id}", id = id), solver.smt.list(vec![solver.smt.atoms().und, solver.smt.atom("BitVec"), solver.smt.numeral(64)]));
    solver.assume(solver.smt.list(vec![solver.smt.atom("ite"), solver.smt.eq(ret7, solver.smt.list(vec![solver.smt.atoms().und, solver.smt.atom("bv0"), solver.smt.numeral(64)])), solver.smt.eq(clret, ret7), solver.smt.eq(clret, solver.smt.list(vec![solver.smt.atom("bvsub"), ret7, solver.smt.list(vec![solver.smt.atoms().und, solver.smt.atom("bv1"), solver.smt.numeral(64)])]))]));
...
pub fn clz1(solver: &mut SolverCtx, x: SExpr, id: u32) -> SExpr {
    ...
    // Generated code.
    let clz1ret = solver.declare(format!("clz1ret_{id}", id = id), solver.smt.list(vec![solver.smt.atoms().und, solver.smt.atom("BitVec"), solver.smt.numeral(1)]));
    solver.assume(solver.smt.eq(clz1ret, solver.smt.list(vec![solver.smt.atom("bvnot"), x])));
