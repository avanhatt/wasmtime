...
pub fn rbit32(solver: &mut SolverCtx, x: SExpr, id: u32) -> SExpr {
    ...
    solver.assume(solver.smt.eq(x1, solver.smt.bvor(solver.smt.bvlshr(a64x, solver.smt.atom("#x00000010")), solver.smt.bvshl(a64x, solver.smt.atom("#x00000010")))));
    ...
    let rbitret = solver.declare(format!("rbitret_{id}", id = id), solver.smt.list(vec![solver.smt.atoms().und, solver.smt.atom("BitVec"), solver.smt.numeral(32)]));
    solver.assume(solver.smt.eq(rbitret, solver.smt.bvor(solver.smt.bvlshr(solver.smt.bvand(x4, solver.smt.atom("#xaaaaaaaa")), solver.smt.atom("#x00000001")), solver.smt.bvshl(solver.smt.bvand(x4, solver.smt.atom("#x55555555")), solver.smt.atom("#x00000001")))));

    let padding = solver.new_fresh_bits(solver.bitwidth - 32);
    solver.smt.concat(padding, rbitret)
}
