...
pub fn a64cls32(solver: &mut SolverCtx, x: SExpr, id: u32) -> SExpr {
    ...
    let a64x = solver.declare(
        format!("a64x_{id}", id = id),
        solver.smt.list(vec![
    ...
    solver.assume(solver.smt.eq(
        ...
        solver.smt.list(vec![
            solver.smt.list(vec![
                solver.smt.atoms().und,
                solver.smt.atom("extract"),
                solver.smt.numeral(31),
                solver.smt.numeral(0),
            ]),
            x,
        ]),
    ));
    ...
    solver.assume(
        solver
            .smt
            .eq(zy16, solver.smt.bvlshr(a64x, solver.smt.atom("#x00000010"))),
    );
    ...
    solver.assume(
        solver
            .smt
            .eq(sy16, solver.smt.bvashr(a64x, solver.smt.atom("#x00000010"))),
    );
    solver.assume(solver.smt.list(vec![
        solver.smt.atom("ite"),
        solver.smt.list(vec![
    ...
    let a64cls32ret = solver.declare(
    ...
    solver.assume(solver.smt.list(vec![
        ...
        solver.smt.eq(a64cls32ret, clzret),
        solver.smt.eq(a64cls32ret, clsret),
    ]));
