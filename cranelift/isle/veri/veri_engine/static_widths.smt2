...
(declare-const uextend__11__x__31 (_ BitVec 64))
...
(assert (! (= uextend__11__result__29 ((_ zero_extend 0) uextend__11__x__31)) :named assum10))
(assert (! (= x__clif2__5 uextend__11__x__31) :named assum11))
(assert (! (= uextend__11 uextend__11__result__29) :named assum12))
...
(assert (! (= uextend__11 has_type__12__arg__35) :named assum16))
...
(assert (! (= false extend__18__b__56) :named assum32))
